  ...
  switch (variant) {
    case "success":
      return {
        ...
        btnClassName: "bg-green-500 hover:bg-green-600 active:bg-green-700 text-white",
      };
    case "error":
      return {
        icon: <XCircle className="text-rose-500" size={24} />,
        btnClassName: "bg-rose-500 hover:bg-rose-600 active:bg-rose-700 text-white",
      };
    case "info":
      return {
        icon: <Info className="text-blue-500" size={24} />,
        btnClassName: "bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white",
      };
    case "warning":
      return {
        icon: <AlertTriangle className="text-yellow-500" size={24} />,
        btnClassName: "bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-700 text-white",
      };
    default:
      return {};
  }
